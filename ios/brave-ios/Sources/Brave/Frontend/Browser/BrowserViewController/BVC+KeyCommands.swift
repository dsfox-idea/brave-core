...
extension BrowserViewController {
  ...
  override public var keyCommands: [UIKeyCommand]? {
    var navigationCommands = [
      ...
      UIKeyCommand(
        title: Strings.Hotkey.reloadPageTitle,
    ...
    let tabMovementCommands = [
      UIKeyCommand(
        title: Strings.Hotkey.backTitle,
        action: #selector(goBackKeyCommand),
        input: UIKeyCommand.inputLeftArrow,
        modifierFlags: .command
      ),
      UIKeyCommand(
        title: Strings.Hotkey.forwardTitle,
    ...
    navigationCommands += [
      UIKeyCommand(
        title: Strings.Hotkey.zoomInTitle,
        action: #selector(zoomInPageKeyCommand),
        input: "+",
        modifierFlags: .command
      ),
      UIKeyCommand(
        title: Strings.Hotkey.zoomOutTitle,
        action: #selector(zoomOutPageKeyCommand),
        input: "-",
        modifierFlags: .command
      ),
    ]
    ...
    navigationCommands += [
      UIKeyCommand(
        title: Strings.Hotkey.selectLocationBarTitle,
        action: #selector(selectLocationBarKeyCommand),
        input: "l",
        modifierFlags: .command
      ),
      UIKeyCommand(
        title: Strings.Hotkey.newTabTitle,
    ...
    navigationCommands += [
      UIKeyCommand(
        title: Strings.Hotkey.closeTabTitle,
      ...
      UIKeyCommand(
        ...
        action: #selector(closeAllTabsKeyCommand),
        input: "w",
    ...
    let tabNavigationKeyCommands = [
      ...
      UIKeyCommand(
        title: Strings.Hotkey.showNextTabTitle,
        action: #selector(nextTabKeyCommand),
        input: UIKeyCommand.inputRightArrow,
        modifierFlags: [.command, .alternate]
      ),
      UIKeyCommand(
        title: Strings.Hotkey.showPreviousTabTitle,
    ...
    navigationCommands += [
      ...
      UIKeyCommand(
        title: Strings.Hotkey.showTabTrayFromTabKeyCodeTitle,
      ...
      UIKeyCommand(
        title: Strings.Hotkey.showHistoryTitle,
        action: #selector(showHistoryKeyCommand),
        input: "y",
        modifierFlags: [.command]
      ),
      UIKeyCommand(
        title: Strings.Hotkey.showDownloadsTitle,
        action: #selector(showDownloadsKeyCommand),
        input: "j",
        modifierFlags: .command
      ),
      UIKeyCommand(
        title: Strings.Hotkey.showShieldsTitle,
        action: #selector(showShieldsKeyCommand),
        input: ",",
        modifierFlags: .command
      ),
    ...
    for index in 1..<10 {
      tabNavigationCommands.append(
        UIKeyCommand(
          input: String(index),
          modifierFlags: [.command],
          action: #selector(showTabKeyCommand(sender:))
        )
      )
    }
    ...
    let bookmarkEditingCommands = [
      UIKeyCommand(
        title: Strings.Hotkey.showBookmarksTitle,
        action: #selector(showBookmarksKeyCommand),
        input: "o",
        modifierFlags: [.shift, .command]
      ),
      UIKeyCommand(
        title: Strings.Hotkey.addBookmarkTitle,
        action: #selector(addBookmarkCommand),
        input: "d",
        modifierFlags: [.command]
      ),
      UIKeyCommand(
        title: Strings.Hotkey.addFavouritesTitle,
        action: #selector(addToFavouritesCommand),
        input: "d",
        modifierFlags: [.command, .shift]
      ),
    ]
    ...
    let shareCommands = [
      UIKeyCommand(
        title: Strings.Hotkey.shareWithTitle,
        action: #selector(shareWithKeyCommand),
        input: "s",
        modifierFlags: .command
      )
    ]
