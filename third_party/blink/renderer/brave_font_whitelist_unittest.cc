...
TEST(BraveFontWhitelistTest, KnownFonts) {
  const std::array<std::tuple<blink::AtomicString, bool>, 10> test_cases = {
#if BUILDFLAG(IS_MAC)
      std::make_tuple<>(blink::AtomicString("-apple-system"), true),
      std::make_tuple<>(blink::AtomicString("system-ui"), true),
      std::make_tuple<>(blink::AtomicString("BlinkMacSystemFont"), true),
      std::make_tuple<>(blink::AtomicString("Arial Unicode MS"), true),
      std::make_tuple<>(blink::AtomicString("Calibri"), false),
      std::make_tuple<>(blink::AtomicString("Gill Sans"), true),
      std::make_tuple<>(blink::AtomicString("Helvetica"), true),
      std::make_tuple<>(blink::AtomicString("Helvetica Neue"), true),
      std::make_tuple<>(blink::AtomicString("Menlo"), true),
      std::make_tuple<>(blink::AtomicString("Franklin Gothic Medium"), false),
#elif BUILDFLAG(IS_WIN)
      std::make_tuple<>(blink::AtomicString("-apple-system"), false),
      std::make_tuple<>(blink::AtomicString("system-ui"), false),
      std::make_tuple<>(blink::AtomicString("BlinkMacSystemFont"), false),
      std::make_tuple<>(blink::AtomicString("Arial Unicode MS"), false),
      std::make_tuple<>(blink::AtomicString("Calibri"), true),
      std::make_tuple<>(blink::AtomicString("Gill Sans"), false),
      std::make_tuple<>(blink::AtomicString("Helvetica"), true),
      std::make_tuple<>(blink::AtomicString("Helvetica Neue"), false),
      std::make_tuple<>(blink::AtomicString("Menlo"), false),
      std::make_tuple<>(blink::AtomicString("Franklin Gothic Medium"), true),
#elif BUILDFLAG(IS_ANDROID)
      std::make_tuple<>(blink::AtomicString("Arial"), true),
      std::make_tuple<>(blink::AtomicString("Coming Soon"), true),
      std::make_tuple<>(blink::AtomicString("Cutive Mono"), true),
      std::make_tuple<>(blink::AtomicString("Georgia"), true),
      std::make_tuple<>(blink::AtomicString("Noto Sans"), true),
      std::make_tuple<>(blink::AtomicString("Roboto"), true),
      std::make_tuple<>(blink::AtomicString("Helvetica"),
                        true),  // recognized alias
      std::make_tuple<>(blink::AtomicString("Helvetica Neue"),
                        false),  // not a recognized alias
      std::make_tuple<>(blink::AtomicString("sans-serif-black"), true),
      std::make_tuple<>(blink::AtomicString("Source Sans Pro"), true),
#elif BUILDFLAG(IS_LINUX)
      std::make_tuple<>(blink::AtomicString("-apple-system"), false),
      std::make_tuple<>(blink::AtomicString("system-ui"), false),
      std::make_tuple<>(blink::AtomicString("BlinkMacSystemFont"), false),
      ...
      std::make_tuple<>(blink::AtomicString("Calibri"), false),
      std::make_tuple<>(blink::AtomicString("Gill Sans"), false),
      std::make_tuple<>(blink::AtomicString("Helvetica"), false),
      std::make_tuple<>(blink::AtomicString("Helvetica Neue"), false),
      std::make_tuple<>(blink::AtomicString("Menlo"), false),
      std::make_tuple<>(blink::AtomicString("Franklin Gothic Medium"), false),
#else
...
TEST(BraveFontWhitelistTest, CaseInsensitivity) {
  const std::array<std::tuple<blink::AtomicString, bool>, 7> test_cases = {
#if BUILDFLAG(IS_MAC)
      std::make_tuple<>(blink::AtomicString("Arial unicode MS"), true),
      std::make_tuple<>(blink::AtomicString("Calibri"), false),
      std::make_tuple<>(blink::AtomicString("gill sans"), true),
