...
void AddBaseline(ColorProvider* provider) {
  ...
  mixer[kColorRefPrimary5] = {SkColorSetRGB(0x08, 0x18, 0x0e)};
  mixer[kColorRefPrimary10] = {SkColorSetRGB(0x0a, 0x20, 0x13)};
  mixer[kColorRefPrimary15] = {SkColorSetRGB(0x0b, 0x28, 0x17)};
  mixer[kColorRefPrimary20] = {SkColorSetRGB(0x0e, 0x33, 0x1e)};
  mixer[kColorRefPrimary25] = {SkColorSetRGB(0x0f, 0x3c, 0x23)};
  mixer[kColorRefPrimary30] = {SkColorSetRGB(0x12, 0x4a, 0x2c)};
  mixer[kColorRefPrimary35] = {SkColorSetRGB(0x00, 0x64, 0x38)};
  mixer[kColorRefPrimary40] = {SkColorSetRGB(0x00, 0x76, 0x43)};
  mixer[kColorRefPrimary50] = {SkColorSetRGB(0x00, 0x90, 0x53)};
  mixer[kColorRefPrimary60] = {SkColorSetRGB(0x1e, 0xa3, 0x62)};
  mixer[kColorRefPrimary70] = {SkColorSetRGB(0x6e, 0xbf, 0x8d)};
  mixer[kColorRefPrimary80] = {SkColorSetRGB(0x82, 0xe0, 0xa6)};
  mixer[kColorRefPrimary90] = {SkColorSetRGB(0xbb, 0xf5, 0xcf)};
  mixer[kColorRefPrimary95] = {SkColorSetRGB(0xe1, 0xfa, 0xe8)};
  mixer[kColorRefPrimary98] = {SkColorSetRGB(0xf3, 0xfd, 0xf6)};
  mixer[kColorRefPrimary99] = {SkColorSetRGB(0xf6, 0xfe, 0xf8)};
