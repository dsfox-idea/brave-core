...
function SetupComplete () {
  // growser: экраны WDP (#24) и HelpImprove (#21) убраны — онбординг
  // завершается здесь. По завершении Lottie-галочки открываем welcome-complete
  // URL (как раньше делал HelpImprove.handleFinish, но без opt-in в P3A/метрику).
