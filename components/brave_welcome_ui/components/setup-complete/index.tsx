...
function SetupComplete () {
  // growser: the WDP (#24) and Help Improve (#21) screens are gone, so onboarding
  // ends here. When the Lottie check mark finishes we open the welcome-complete
  // URL - what HelpImprove.handleFinish used to do, minus the opt-in it wrote.
