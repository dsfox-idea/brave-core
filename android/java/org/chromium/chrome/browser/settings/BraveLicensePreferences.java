...
public class BraveLicensePreferences extends BravePreferenceFragment {
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String s) {
        ...
        // Growser-312: the legal screen no longer shows Google's titles either.
        assert R.string.google_terms_of_service_title > 0
                : "Something has changed in the upstream!";
        assert R.string.privacy_policy_title > 0 : "Something has changed in the upstream!";
