...
public final class BraveConstants {
    ...
    // Growser-265: these are compared against getPackageName(), so they
    // move with chrome_public_manifest_package in buildArgs.ts or every
    // comparison quietly answers false.
    public static final String BRAVE_PRODUCTION_PACKAGE_NAME = "org.growser";
    public static final String BRAVE_BETA_PACKAGE_NAME = "org.growser.beta";
    public static final String BRAVE_NIGHTLY_PACKAGE_NAME = "org.growser.nightly";
    public static final String BRAVE_DEBUG_PACKAGE_NAME = "org.growser.debug";
