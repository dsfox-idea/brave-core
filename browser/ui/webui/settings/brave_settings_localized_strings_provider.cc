...
void BraveAddCommonStrings(content::WebUIDataSource* html_source,
  ...
  webui::LocalizedString localized_strings[] = {
      ...
      {"appearanceSettingsSidebarShowPinnedTabsSubLabel",
       IDS_SETTINGS_APPEARANCE_SETTINGS_SIDEBAR_SHOW_PINNED_TABS_SUB_LABEL},
      {"appearanceSettingsSidebarShowPinnedTabsVerticalTabsTooltip",
       IDS_SETTINGS_APPEARANCE_SETTINGS_SIDEBAR_SHOW_PINNED_TABS_VERTICAL_TABS_TOOLTIP},
